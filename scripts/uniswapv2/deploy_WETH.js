...
async function main() {
    //npx hardhat run scripts/uniswapv2/deploy_WETH.js --network bsc-testnet
    ...
    const UniswapV2Factory = await hre.ethers.getContractFactory("WMATIC");
    const implimentationSC = await UniswapV2Factory.deploy()
